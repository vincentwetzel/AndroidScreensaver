...
- [x] Main source cards use persisted selected-folder media counts while repositories refresh expensive counts in the background.
...
- [x] Folder browser navigation, inherited parent-folder selection, immediate auto-save, pull-to-refresh, thumbnails, and selected-count summaries.
